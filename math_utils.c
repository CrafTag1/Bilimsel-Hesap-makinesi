...
// klasik öklid yöntemiyle ebob bulma, b sıfır olana kadar dönüyor
...
// 6k +- 1 kuralına göre asallık kontrolü
...
// genişletilmiş oklid ile moduler ters bulma
long long mod_inverse(long long a, long long m, int *hata_var_mi)
{
    long long m0 = m, t, q;
    long long x0 = 0, x1 = 1;

    // ebob 1 değilse tersi yoktur
    if (m == 1 || gcd(a, m) != 1)
    {
        *hata_var_mi = 1;
        return 0;
